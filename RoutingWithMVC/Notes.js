...
URL Is request
App: receive URL - check related data - map to controller - and send response
URL first go towards routing mechanism then controller
CONVENTION BASED ROUTING: For Normal web app
ATTRIBUTE BASED ROUTING : For Normal + API web app
...
// ====================================== 09 ====================================== //
/*
   Our HTTP request pipeline is congigure in program.cs
   {controller=Home}/{action=Index}/{id?} This is convention based routing
   Is pattern ko follow kar ke hamari request generate hogi
   (?) optional
   .cshtml: View extension
   Add service to use controller
   Our app eg. Home,About etc pages come in 1 controller. If we want dashboard pages so it will come in another controller
